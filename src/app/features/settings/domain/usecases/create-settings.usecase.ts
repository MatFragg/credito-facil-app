...
import { Settings, CreateSettingsData } from '../models/settings.model';
import { InterestRateType } from '../models/interest-rate-type.enum';
import { Currency } from '../models/currency.enum';

/**
 * Use Case: Create Settings
 * Creates new settings with business validation
 */
@Injectable()
export class CreateSettingsUseCase {
    constructor(private repository: SettingsRepository) { }

    execute(data: CreateSettingsData): Observable<Settings> {
        // Business validation
    ...
    private validateSettings(data: CreateSettingsData): void {
        // Validate currency
